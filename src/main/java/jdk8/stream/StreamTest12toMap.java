...
public class StreamTest12toMap {
    ...
    public static void main(String[] args) {
        Student stu1 = new Student("zhangsan", 100, 20, "15985857700");
        Student stu2 = new Student("lisi", 90, 20, "15985857701");
        Student stu3 = new Student("wangwu", 70, 30, "15985857702");
        Student stu4 = new Student("lisi", 80, 40, "15985857703");
